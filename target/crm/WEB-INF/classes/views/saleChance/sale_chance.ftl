...
<form class="layui-form" >
	...
	<script type="text/html" id="toolbarDemo">
		<div class="layui-btn-container">
			<a class="layui-btn layui-btn-normal addNews_btn" lay-event="add" id="addbtn">
	...
	<script id="saleChanceListBar" type="text/html">
		<a class="layui-btn layui-btn-xs" id="edit" lay-event="updataBar">编辑</a>
		<a class="layui-btn layui-btn-xs layui-btn-danger" lay-event="deleteBar">删除</a>
	</script>
